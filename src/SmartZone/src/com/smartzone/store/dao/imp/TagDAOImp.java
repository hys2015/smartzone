 ...
 * 
 * @see com.smartzone.store.entity.Tag
...
public class TagDAOImp implements TagDAO {
	...
	/* (non-Javadoc)
	 * @see com.smartzone.store.dao.imp.TagDAO#save(com.smartzone.store.entity.Tag)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.smartzone.store.dao.imp.TagDAO#delete(com.smartzone.store.entity.Tag)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.smartzone.store.dao.imp.TagDAO#findById(java.lang.Integer)
	 */
	@Override
	public Tag findById(java.lang.Integer id) {
		...
		try {
			Tag instance = (Tag) getCurrentSession().get(
					"com.smartzone.store.entity.Tag", id);
			return instance;
		} catch (RuntimeException re) {
	...
	/* (non-Javadoc)
	 * @see com.smartzone.store.dao.imp.TagDAO#findByExample(com.smartzone.store.entity.Tag)
	 */
	@Override
	public List findByExample(Tag instance) {
		...
		try {
			List results = getCurrentSession()
					.createCriteria("com.smartzone.store.entity.Tag")
	...
	/* (non-Javadoc)
	 * @see com.smartzone.store.dao.imp.TagDAO#findByProperty(java.lang.String, java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.smartzone.store.dao.imp.TagDAO#findAll()
	 */
	@Override
	public List findAll() {
