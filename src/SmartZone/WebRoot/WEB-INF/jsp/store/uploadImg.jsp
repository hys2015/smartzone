...
<div class="container-fluid">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<s:form onsubmit="return formvalidate(this, '请选择需要上传的图片');" enctype="multipart/form-data" action="uploadShopImg" namespace="/store">
					...
					<div class="form-group">
						<label>照片简述(请少于20字)</label>
						<input class="form-control" type="text" name="shopImg.brief">
					</div>
